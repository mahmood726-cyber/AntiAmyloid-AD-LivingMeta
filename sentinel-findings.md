...
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:2364`
...
- **When:** 2026-06-13T10:58:01.874220+00:00

## [WARN] P1-fabrication-orphan-trial
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:5080`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:5083`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:5086`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:5089`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:16157`
...
## [WARN] P1-fabrication-orphan-trial
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:22992`
...
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:1`
...
- **When:** 2026-06-13T10:58:01.999420+00:00

## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:29982`
...
- **When:** 2026-06-13T10:58:04.399334+00:00

## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:35245`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:36931`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:36934`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:43899`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:43943`
- **Detail:** `parseInt(r.k) || 0` drops 0/0.0 silently — parsed zero is falsy and falls through to the right-hand fallback
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T10:58:04.399334+00:00
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:44005`
- **Detail:** `parseInt(r.k) || 0` drops 0/0.0 silently — parsed zero is falsy and falls through to the right-hand fallback
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T10:58:04.399334+00:00
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:44337`
...
## [WARN] P2-numeric-parse-or-null
- **Location:** `ANTI_AMYLOID_AD_REVIEW.html:44355`
...
- **When:** 2026-06-13T11:00:27.638792+00:00

## [WARN] P1-unpopulated-placeholder
- **Location:** `test_smoke.py:45`
- **Detail:** pattern matched: # Handlebars-style {{NAME}} tokens, but NOT JS `${{...}}` interpolation
- **Fix hint:** Populate the placeholder or escape it before shipping. If the braces are intentional template syntax in a non-template file, exclude the file path via the rule's exclude list.

- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:00:27.638810+00:00
...
- **Fix hint:** verify NCT12345678 against ClinicalTrials.gov; either add it to realData with full extracted fields, or remove the prose citation if it was inherited from a different paper
- **Source:** F:\e156\docs\assurance-standard.md#data-provenance-match  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:00:28.512235+00:00
...
- **Fix hint:** verify the quoted values against the source
- **Source:** F:\e156\docs\assurance-standard.md#data-checking  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:00:28.670854+00:00
...
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:00:30.910036+00:00
...
- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:00:40.936605+00:00
...
- **Source:** html-apps.md#safety-checks
- **When:** 2026-06-13T11:00:40.936628+00:00
...
- **Fix hint:** verify NCT12345678 against ClinicalTrials.gov; either add it to realData with full extracted fields, or remove the prose citation if it was inherited from a different paper
- **Source:** F:\e156\docs\assurance-standard.md#data-provenance-match  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:00:41.812769+00:00
...
- **Fix hint:** verify the quoted values against the source
- **Source:** F:\e156\docs\assurance-standard.md#data-checking  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:00:41.987463+00:00
...
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:00:44.779780+00:00
...
- **Fix hint:** verify NCT12345678 against ClinicalTrials.gov; either add it to realData with full extracted fields, or remove the prose citation if it was inherited from a different paper
- **Source:** F:\e156\docs\assurance-standard.md#data-provenance-match  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:01:03.409529+00:00
...
- **Fix hint:** verify the quoted values against the source
- **Source:** F:\e156\docs\assurance-standard.md#data-checking  (BadScientist family, arXiv 2510.18003)
- **When:** 2026-06-13T11:01:03.561758+00:00
...
- **Fix hint:** use `Number.isFinite(parsed) ? parsed : null` after a single parseFloat/parseInt/Number call
- **Source:** lessons.md#javascript--html  (parseFloat(x) || null drops 0.0)
- **When:** 2026-06-13T11:01:05.824157+00:00
